...
namespace ZenithFit.MobileApp.ViewModels
{
    ...
    private string StripeTestApiKey = "pk_test_51I1InxFznLeaOqQni5IVV8e3vh8RuQIsaioVmGHAAAPOffuXzBsbI3RO5JY2JguLch7QZW5whs6PlB7ppeGLtyY700jZjOuyGw";
    private string StripeSecretApiKey = "sk_test_51I1InxFznLeaOqQnxQ7obLCtItVwYN9d9Vq4tT6JeoGrd7XnLLtceVESKYxRkJ0WAQNr7QuU8FpKdsWscQVKZS1J00q8kabDKv";
        ...
        try
        {
            ...
            var Tokenoptions = new TokenCreateOptions
            {
                Card = new TokenCardOptions
                {
                    ...
                    Name = LoggedInUser.ActiveClient.ClientUsername,
        ...
        public bool MakePayment(string token)
    {
        try
        {
            ...
            var options = new ChargeCreateOptions
            {
                ...
                Currency = "bam",
                Description = "Charge for " + LoggedInUser.ActiveClient.ClientEmail,
