...
namespace ZenithFit.WebAPI.Database
{
    public partial class ZenithFitDatabaseContext
    {
        partial void OnModelCreatingPartial(ModelBuilder modelBuilder)
        {
            ...
            new Clients() { ClientId = 1, ClientFirstName = "Amer", ClientLastName = "Bilic", ClientRegisterDate = DateTime.Now.AddDays(-5), ClientEmail = "testing1@email.com", ClientPhone = "1233455", ClientUsername = "mobile", PasswordHash = "r577PsUb6lkHEs32NUsQHbqEhqc=", PasswordSalt = "jpiaSiCqXBnw1z4lUnuRww==" },
